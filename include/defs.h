...
#define REALM_WIDTH_SMALL   7
#define REALM_HEIGHT_SMALL  5
...
#define REALM_WIDTH_MEDIUM   7
#define REALM_HEIGHT_MEDIUM  5
...
#define REALM_WIDTH_LARGE   7
#define REALM_HEIGHT_LARGE  5
